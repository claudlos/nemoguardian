...
- Adapter tests cover unsafe delete, action toggles, controversial flag, bot-message ignore, configured exclusions, mod-log output, case lookup, history, Twitch action planning, and webhook auth.
